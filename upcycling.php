                ...
                <div class="p-3 card">
                    ...
                    <div class="col-md-6">
                        <div class="h-99 p-5">
                            ...
                            <h2>What is it?</h2>
                            <p>Enclica Software, hoping to save the enviromental impact by reusing old machines by
                                fixing
                                them up and selling on these pcs are coming from individuals and businesses across the
                                UK as
                                donations.</p>
                        </div>
                    </div>
            ...
            <div class="p-5  rounded-3">
                <div class="container-fluid py-5">
                    <div class="col-md-6">
                        <div class=" p-5">
                            <h2>Stages 1-3</h2>
                            <p>Stage 1 consists of retreiving the pcs from individuals and businesses by either
                                requesting
                                them directly or
                                they contact us either by social media or through our website.</p>
                            <p>Stage 2 consists of diagnosing the pcs to see if there are any issues we dont touch any
                                data
                            ...
                            <h2>Stages 4-6</h2>
                            <p>stage 4 consists of fixing any hardware issues in the pc discovered by the diagnostics.
                            </p>
                            <p>stage 5 consists of going through a checklist of issues and seeing if there are any
                                problems
                                further on.</p>
            ...
            <div class="container-fluid py-5">
                <div class="col-md-6">
                    <div class=" p-5">
                        ...
                        <a class="btn btn-primary n-o" href="/dl/agreements/agreement1.docx">Donate PC (Southampton,
                            Gosport, Fareham,
                            Waltham Chase, Bishops
                            Waltham and surrounding areas) agreement form.</a><br /><br />
                        <!--<button class="btn btn-primary">Donate PC (Kent,London) form.</button><br /><br />
                        <button class="btn btn-primary">Donate PC (Glasgow,Edinburgh) form.</button><br /><br />
                        <button class="btn btn-primary">Donate PC (Wales) form.</button><br /><br /> -->
