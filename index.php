        ...
        <div class="p-5 mb-1  rounded-3">
            <div class="container-fluid py-5">
                <div class="container-fluid py-5 card p-4">
                    ...
                    <P class="col-md-9 fs-4">We make software and webbased applications for multiple indistries and consumers.</P>
                    <P class="col-md-9 fs-4">We are a small team of people who are passionate about software and web development.</P>
                    <p class="col-md-9 fs-4">We are dedicated to privacy of our users.</p>
                    <a href="/about" class="btn btn-primary btn-sm" type="button">learn more</a>
                </div>
            </div>
        </div>
